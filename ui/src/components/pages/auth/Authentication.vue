    ...
    <div class="l-auth">
      <v-form v-model="validSignIn">
        ...
        <v-text-field label="Password"
                      ...
                      prepend-icon="lock"
                      :rules="rules"
                      :append-icon="signInPasswordVisible ? 'visibility' : 'visibility_off'"
                      :append-icon-cb="() => (signInPasswordVisible = !signInPasswordVisible)"
        ...
        <v-btn color="light-blue lighten-1" @click.native="submitSignIn()">Sign In</v-btn>
      </v-form>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      submitSignIn () {
        Authentication.signIn(this, this.credentials, '/')
      },
